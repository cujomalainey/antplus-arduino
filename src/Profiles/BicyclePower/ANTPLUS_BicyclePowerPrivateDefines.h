...
/* Sensor Types */
#define BICYCLEPOWER_SENSORTYPE_POWERONLY       0
#define BICYCLEPOWER_SENSORTYPE_TORQUEWHEEL 		1
#define BICYCLEPOWER_SENSORTYPE_TORQUECRANK 		2
#define BICYCLEPOWER_SENSORTYPE_CTF          		3
